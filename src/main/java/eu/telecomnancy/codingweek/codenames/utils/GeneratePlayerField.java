...
public class GeneratePlayerField {
    public static Node generateField(String name, NewConfigController newConfigController) {
        ...
        try {
            ...
            loader.setControllerFactory(iC -> new PlayerFieldController(name, newConfigController));
            return loader.load();
        } catch (Exception e) {
            e.printStackTrace();
            return null;
